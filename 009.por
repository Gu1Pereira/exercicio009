...
/*
médias
Este exemplo pede ao usuário que informe três médias. Logo após, calcule e exibe a média final destas notas.
Por ultimo, verifica se alguma das médias parciais é menor que a média final e a 
exibe (caso exista).
*/
